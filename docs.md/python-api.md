...
| `provider`              | LLM provider: `"lmstudio"`, `"llamacpp"`, `"huggingface"`, `"openrouter"`, `"chatgpt"`, `"google"`, `"geap"` (`"vertexai"` is an alias), `"bedrock"`, `"generic"`, `"applefm"`, `"command"`, or a command string.                                                                          |
